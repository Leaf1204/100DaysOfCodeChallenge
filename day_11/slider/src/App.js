          ...
          <div className="t-image">
            <ul ref={el => (imageList = el)}>
              <li className={state.isActive1 ? "active" : ""}>
                <img src='https://i.imgur.com/c4I17bM.jpg' alt={testimonials[0].name} />
              </li>
              <li className={state.isActive2 ? "active" : ""}>
                <img src='https://i.imgur.com/UruLMgf.jpg' alt={testimonials[0].name} />
              </li>
              <li className={state.isActive3 ? "active" : ""}>
                <img src='https://i.imgur.com/sKnSRla.jpg' alt={testimonials[0].name} />
              </li>
            </ul>
          </div>
